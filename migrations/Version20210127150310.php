 ...
 */
final class Version20210127150310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recepten (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, arts_id SMALLINT DEFAULT NULL, dosis INT NOT NULL, duur INT NOT NULL, herhalingen SMALLINT DEFAULT NULL, afgifte_datum DATE NOT NULL, gebruiken_tot DATE NOT NULL, INDEX IDX_72C1CA26B899279 (patient_id), INDEX IDX_72C1CA21A9F61BA (arts_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
